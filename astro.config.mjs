...
export default defineConfig({
  ...
  integrations: [starlight({
      ...
      sidebar: [
        { label: 'Intro & Custom Elements', collapsed: true, items: [{ autogenerate: { directory: 'intro-custom-elements' } }] },
        { label: 'Lifecycle Callbacks', collapsed: true, items: [{ autogenerate: { directory: 'lifecycle' } }] },
        { label: 'Shadow DOM', collapsed: true, items: [{ autogenerate: { directory: 'shadow-dom' } }] },
        { label: 'Templates & Slots', collapsed: true, items: [{ autogenerate: { directory: 'templates-slots' } }] },
        { label: 'Styling', collapsed: true, items: [{ autogenerate: { directory: 'styling' } }] },
        { label: 'Attributes, Properties & Events', collapsed: true, items: [{ autogenerate: { directory: 'attributes-properties-events' } }] },
        { label: 'Patterns & Composition', collapsed: true, items: [{ autogenerate: { directory: 'patterns-composition' } }] },
        { label: 'Lit & Tooling', collapsed: true, items: [{ autogenerate: { directory: 'lit-and-tooling' } }] },
      ],
      }), preact()],
});
