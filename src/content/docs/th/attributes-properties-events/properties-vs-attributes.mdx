...
> 💡 Real World Example
>
> Element `<input>` ดั้งเดิมของเบราว์เซอร์คือตัวอย่างที่ชัดเจนที่สุดของความแตกต่างนี้ — attribute `value` คือค่าเริ่มต้น (default value) ที่ตั้งมาจาก HTML ส่วน property `.value` คือค่าปัจจุบันที่ผู้ใช้พิมพ์อยู่ตอนนี้ ทั้งสองค่าต่างกันได้ทันทีที่ผู้ใช้เริ่มพิมพ์
>
