...
`::slotted(selector)` สามารถ match ได้เฉพาะ children ที่ถูก slot โดยตรง — ไม่สามารถเข้าถึง subtree ของ children เหล่านั้นได้ ในการจัดสไตล์เนื้อหาที่ลึกขึ้น ให้ปรับโครงสร้าง HTML ของคุณ หรือใช้ CSS custom properties ที่ส่งเข้ามาจากภายนอก
</Tip>
