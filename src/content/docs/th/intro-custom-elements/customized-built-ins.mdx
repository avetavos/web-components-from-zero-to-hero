...
> 💡 ตัวอย่างจากของจริง
>
> **GitHub** — เลือกสร้าง `<relative-time>` และ `<clipboard-copy>` เป็น autonomous elements แทนที่จะใช้ customized built-ins เพื่อให้ทำงานได้ในทุก browser รวมถึง Safari ([github/relative-time-element](https://github.com/github/relative-time-element))
>
> **Adobe Spectrum** — ดีไซน์ระบบ Spectrum Web Components เลือกใช้ autonomous elements เป็นหลักด้วยเหตุผลด้านการพกพาข้าม browser เดียวกันนี้ ([opensource.adobe.com](https://opensource.adobe.com/spectrum-web-components/))
