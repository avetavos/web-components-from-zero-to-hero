...
> 💡 ตัวอย่างจากของจริง
>
> **Salesforce Lightning (LWC)** — เรียก `attachShadow` เป็นส่วนหนึ่งของ lifecycle ของทุก component เพื่อ encapsulate UI ระดับ enterprise ที่มีหลายทีมพัฒนาพร้อมกัน ([salesforce/lwc](https://github.com/salesforce/lwc))
