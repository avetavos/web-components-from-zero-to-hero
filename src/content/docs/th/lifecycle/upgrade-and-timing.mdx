...
ใช้ `my-el:not(:defined) { visibility: hidden; }` เพื่อซ่อน element ที่ยังไม่ถูก upgrade วิธีนี้ป้องกันการแสดง placeholder แบบ raw ชั่วคราวขณะที่ script กำลังโหลดและ define element อยู่
</Tip>
