...
ต่อมาเมื่อ script เรียก `customElements.define('my-el', MyEl)` browser จะ **upgrade**: มันจะวนหา element ทุกตัวที่ตรงกับ tag นั้นในเอกสาร แล้วเรียก constructor ของ `MyEl` กับแต่ละตัว จากนั้นเรียก `connectedCallback` หาก element นั้นอยู่ใน DOM อยู่แล้ว
