...
> 💡 ตัวอย่างจากของจริง
>
> **Stencil** (compiler ที่อยู่เบื้องหลัง component ของ Ionic Framework) เอกสาร lifecycle ของมันระบุการแบ่งงานแบบนี้ไว้ชัดเจน: เก็บเฉพาะ internal state ไว้ใน constructor และย้าย logic ที่ต้องพึ่งพา attribute/DOM ไปไว้ใน `connectedCallback` หรือ `componentWillLoad` เพื่อให้ component ทนต่อการถูก re-mount ซ้ำในแอปแบบ SPA ([stenciljs.com/docs/component-lifecycle](https://stenciljs.com/docs/component-lifecycle))
...
export const quizCtorConnected = [
  {
    ...
    options: [
      ...
      'Element ยังไม่ได้เชื่อมต่อกับ document ตอนที่ถูก construct',
